...
from .permission import IsCandidate
...
from .serializers import JobPostSerializer, UserApplyJobPostSerializer
...
class UserApplyJobPostView(APIView):
    permission_classes = [IsCandidate]
    authentication_classes = [JWTAuthentication]
    def post(self, request):
        cur_user = request.user.id
        request.data['user'] = cur_user
        job_post_serializer = UserApplyJobPostSerializer(data = request.data)
