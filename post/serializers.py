...
class UserApplyJobPostSerializer(serializers.ModelSerializer):
    job_post = serializers.IntegerField()
    user = serializers.IntegerField()
    def create(self, validated_data):
        user = User.objects.get(id = validated_data['user'])
        job_post = JobPost.objects.get(id = validated_data['job_post'])
        new_obj = UserApplyJopPost(user = user , job_post = job_post)
        return new_obj
    class Meta:
        model = UserApplyJopPost
